...
def main():
    ...
    print("\nGenerated files:")
    print("  Models:")
    print("    - models/bi_min_lstm_best.keras")
    print("    - models/bi_min_lstm_final.keras")
    print("  Plots:")
    print("    - plots/bi_min_lstm_training_history.png")
    print("    - plots/bi_min_lstm_confusion_matrix.png")
    print("  Metrics:")
    print("    - plots/bi_min_lstm_metrics.txt")
    print("="*60)
